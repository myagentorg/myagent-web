        ...
        <section className="detailed-info">
            <div className="detailed-info__wrapper">
                <h3 className="detailed-info__heading">
                    Find Top Real Estate Agents in Your City
                </h3>
                ...
                <div className="detailed-info__content">
                    <p>
                        Start by telling us about the property you’re selling or
                        your dream home. Let us know the area, property type, your
                        budget or desired price, and anything else that you think
                        might help us to best match you with top real estate agents
                        in your area.
                    </p>
                    <p>
                        Using your information, we then analyze it and compare it to
                        our proprietary agent and broker database. We look at
                        metrics like agent close rate, observational data, and
                        consumer reviews to find the best agent match for you.
                    </p>
                    <p>
                        Finally, our agent specialists personally review every
                        request. If more information is needed, we will reach out to
                        you to find your perfect agent. Once we have everything we
                        need, we’ll introduce you to your agent match.
                    </p>
                </div>
                <h3 className="detailed-info__heading">
                ...
                <div className="detailed-info__content">
                    <p>
                        ...
                        U.S., it’s not easy deciding who to trust when buying or
                        selling a home.
                    </p>
                    <p>
                        A top real estate agent will set and negotiate the best
                        price for your property and help you thoroughly understand
                        the local real estate market.
                    </p>
                    <p>
                        They’ll quickly respond to your needs, help you find
                        listings before they’re public, mind every little detail,
                        and earn your respect for life.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        larger firms like Century 21, RE/MAX, and Keller Williams,
                        to find the best agent for you.
                    </p>
                    <p>
                ...
                <div className="detailed-info__content">
                    <p>
                        ...
                        MyAgent.io is the easiest and fastest way to find the best
                        agent for you.
                    </p>
                </div>
            </div>
