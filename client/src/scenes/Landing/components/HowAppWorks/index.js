        ...
        <div className="how-app-works">
            <div className="utility-wrapper">
                <div className="how-app-works__headline">
                    ...
                    <span className="color-emphasize">150,000</span> home buyers
                    and sellers find their perfect real estate agent…
                </div>
                <div className="how-app-works__steps">
                    <div className="how-app-works__step">
                        ...
                        desired price or budget, and anything else that you
                        think might help us to best{' '}
                    ...
                    <div className="how-app-works__step">
                        ...
                        proprietary agent and broker database. In addition to
                        area, property, and pricing info, we look at metrics
                        like agent close rates, observational data, and consumer
                        reviews to find <strong>the best agent for you</strong>.
                    </div>
                    <div className="how-app-works__step">
                        <img
                            className="step__img"
                        ...
                        Our agent specialists personally review every request
                        and will reach out to you if we need additional info to
                        find your perfect real estate agent. Once we have
                        everything we need, we’ll{' '}
